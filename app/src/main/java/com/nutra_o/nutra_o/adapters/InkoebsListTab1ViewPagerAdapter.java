...
import com.nutra_o.nutra_o.fragments.tabmenu.InkoebslisterTab2Fragment;
...
public class InkoebsListTab1ViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        {
            IndkoebslisterTab1Fragment tab1 = new IndkoebslisterTab1Fragment();
            return tab1;
        }
        else             // As we are having 2 tabs if the position is now 0 it must be 1 so we are returning second tab
        {
            InkoebslisterTab2Fragment tab2 = new InkoebslisterTab2Fragment();
            return tab2;
        }
    }
